...
<form action="<%=path %>/CardHandle?type=2" method="post">
    <table style=" margin:50px auto;">
        ...
        <tr>
            <td>IC卡编号：</td>
            <td><input type="text" name="card_id" value="<%=obj[0] %>" readonly/></td>
        </tr>
        <tr>
            <td>车位编号：</td>
            <td>
        ...
        <tr>
            <td>用户名称：</td>
            <td><input type="text" name="user_name" value="<%=obj[2] %>"/></td>
        </tr>
        <tr>
            <td>用户性别：</td>
            <td>
        ...
        <tr>
            <td>用户地址：</td>
            <td><input type="text" name="user_addr" value="<%=obj[4] %>" required/></td>
        </tr>
        <tr>
            <td>车牌号码：</td>
            <td><input type="text" name="car_num" value="<%=obj[5] %>" required/></td>
        </tr>
