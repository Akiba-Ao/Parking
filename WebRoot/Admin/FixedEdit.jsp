...
<form action="<%=path %>/FixedHandle?type=2" method="post">
    <table style=" margin:50px auto;">
        ...
        <tr>
            <td>记录编号：</td>
            <td><input type="text" name="fixed_id" value="<%=obj[0] %>"/></td>
        </tr>
        <tr>
            <td>IC卡号：</td>
            <td><input type="text" name="card_id" value="<%=obj[1] %>"/></td>
        </tr>
        <tr>
            <td>入场日期：</td>
            <td><input type="text" name="entry_date" value="<%=obj[2] %>"/></td>
        </tr>
        <tr>
            <td>入场时间：</td>
            <td><input type="text" name="entry_time" value="<%=obj[3] %>"/></td>
        </tr>
        <tr>
            <td>出场日期：</td>
            <td><input type="text" name="out_date" value="<%=obj[4] %>"/></td>
        </tr>
        <tr>
            <td>出场时间：</td>
            <td><input type="text" name="out_time" value="<%=obj[5] %>"/></td>
        </tr>
