...
<form action="<%=path %>/SeatHandle?type=2" method="post">
    <table style=" margin:50px auto;">
        ...
        <tr>
            <td>车位ID：</td>
            <td><input type="text" name="seat_id" value="<%=obj[0] %>" readonly/></td>
        </tr>
        <tr>
            <td>车位编号：</td>
            <td><input type="text" name="seat_num" value="<%=obj[1] %>" required/></td>
        </tr>
        <tr>
            <td>车位区域：</td>
            <td>
        ...
        <tr>
            <td>车位备注：</td>
            <td><input type="text" name="seat_tag" value="<%=obj[4] %>"/></td>
        </tr>
