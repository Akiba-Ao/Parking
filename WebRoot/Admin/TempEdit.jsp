...
<form action="<%=path %>/TempHandle?type=2" method="post">
    <table style=" margin:50px auto;">
        ...
        <tr>
            <td>临时编号：</td>
            <td><input type="text" name="temp_id" value="<%=obj[0] %>" readonly="readonly"/></td>
        </tr>
        <tr>
            <td>ID编号：</td>
            <td><input type="text" name="card_id" value="<%=obj[1] %>" readonly="readonly"/></td>
        </tr>
        <tr>
            <td>车辆编号：</td>
            <td><input type="text" name="car_num" value="<%=obj[2] %>" readonly="readonly"/></td>
        </tr>
        <tr>
            <td>入场日期：</td>
            <td><input type="text" name="entry_date" value="<%=obj[3] %>" readonly="readonly"/></td>
        </tr>
        <tr>
            <td>入场时间：</td>
            <td><input type="text" name="entry_time" value="<%=obj[4] %>" readonly="readonly"/></td>
        </tr>
        <tr>
            <td>出场日期：</td>
            <td><input type="text" name="out_date" value="" readonly="readonly"/></td>
        </tr>
        <tr>
            <td>出场时间：</td>
            <td><input type="text" name="out_time" value="" readonly="readonly"/></td>
        </tr>
        <tr>
            <td>停车小时：</td>
            <td><input type="text" name="time" value="" readonly="readonly" style="width:140px"/>小时</td>
        </tr>
        <tr>
            <td>停车单价：</td>
            <td><input type="text" name="price" value="3" style="width:140px"/>每小时</td>
        </tr>
        <tr>
            <td>总费用：</td>
            <td><input type="text" name="temp_money" style="width:140px" value="<%=obj[7] %>" readonly="readonly"/>元
            </td>
        </tr>
        </tbody>
