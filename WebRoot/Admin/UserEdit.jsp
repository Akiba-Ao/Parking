...
<form action="<%=path %>/UserHandle?type=2" method="post">
    <table style=" margin:50px auto;">
        ...
        <tr>
            <td>用户编号：</td>
            <td><input type="text" name="user_id" value="<%=obj[0] %>" readonly="readonly"/></td>
        </tr>
        <tr>
            <td>角色名称：</td>
            <td>
        ...
        <tr>
            <td>用户昵称：</td>
            <td><input type="text" name="user_name" value="<%=obj[2] %>" required/></td>
        </tr>
        <tr>
            <td>真实姓名：</td>
            <td><input type="text" name="real_name" value="<%=obj[3] %>" required/></td>
        </tr>
        <tr>
            <td>用户密码：</td>
            <td><input type="text" name="user_pwd" value="<%=obj[4] %>" required pattern="^\w{6,}$" title="密码长度不能少于6位"/>
            </td>
        </tr>
        <tr>
            <td>联系方式：</td>
            <td><input type="text" name="user_phone" value="<%=obj[5] %>" pattern="^1[1-9]\d{9}$" title="手机号码有误"/></td>
        </tr>
